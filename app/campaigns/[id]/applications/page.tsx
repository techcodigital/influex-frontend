...
export default function CampaignApplications() {
  ...
  >
    <div 
      style={{ background:"#fff", borderRadius:20, padding:"32px 28px", maxWidth:360, width:"100%", textAlign:"center" }}
      onClick={e => e.stopPropagation()}
    >
      <div style={{ fontSize:48, marginBottom:16 }}>🚧</div>
      <div style={{ fontSize:20, fontWeight:800, color:"#111", marginBottom:8 }}>Deal Feature Coming Soon</div>
      <div style={{ fontSize:14, color:"#888", lineHeight:1.6, marginBottom:24 }}>
        The deals feature is currently not available. We're working on it and it will be live soon!
      </div>
      <button 
        onClick={() => setShowDealModal(false)}
        style={{ padding:"11px 32px", background:"#4f46e5", color:"#fff", border:"none", borderRadius:12, fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"Plus Jakarta Sans, sans-serif" }}
      >
        Got it
      </button>
    </div>
...
<div className="ap-info-item">
  ...
  <div className="ap-info-val">{subCategories || "N/A"}</div>
                  ...
                  <div className="ap-actions">
                    ...
                    <button className="ap-btn ap-btn-deal" onClick={() => setShowDealModal(true)}>🤝 Deal</button>
                      </div>
                    )}
                  </div>
                </div>
