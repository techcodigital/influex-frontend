...
//       // if (!hasProfile) { router.push("/my-profile"); return; }
...
// >
//   <img
//     src="/collabzy-logo.png"   // 👈 yaha apni image ka path do
//     alt="Collabzy"
//     style={{ 
//       height: "100%", 
//        width: "100%", 
...
//                     type="submit"
//                     disabled={fpLoading}
//                     style={{padding:"13px",background:fpLoading?"#a5b4fc":"linear-gradient(135deg,#4f46e5,#7c3aed)",color:"#fff",border:"none",borderRadius:14,fontSize:14,fontWeight:700,cursor:fpLoading?"not-allowed":"pointer",fontFamily:"inherit"}}
//                   >
//                     {fpLoading ? "Sending..." : "Send Reset Link"}
//                   </button>
//                 </form>
...
//                   style={{padding:"12px 28px",background:"linear-gradient(135deg,#4f46e5,#7c3aed)",color:"#fff",border:"none",borderRadius:14,fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}
//                 >
//                   Done
//                 </button>
//               </div>
