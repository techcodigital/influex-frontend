...
const MAX_REELS = 2;
const MAX_POSTS = 3;
const MAX_REEL_SIZE_BYTES = 100 * 1024 * 1024; // ✅ 100MB for reels
const MAX_POST_SIZE_BYTES = 10  * 1024 * 1024;  // 10MB for images
...
const validateFile = (file: File, type: "reel" | "post"): string | null => {
  ...
  if (file.size > maxSize) {
    return `Too large (${(file.size / 1024 / 1024).toFixed(1)}MB). Max ${maxLabel}.`;
  }
